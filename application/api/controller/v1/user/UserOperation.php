...
class UserOperation extends Auth{
    ...
    public function getUserGroup () {
        return \think\Loader::model('UserOperationLogic','logic\v1\user')->getUserGroup($this->company_id);
    }
     ...
     * 修改个人姓名
     * 请求类型 post
	 * 传入JSON格式: {"user_name":"user_name..."}
	 * 返回JSON格式: {"meta":{"code":200,"message":"success"},"body":null}
	 * API_URL_本地: http://localhost:91/api/v1/user/UserOperation/updateUserName
	 * API_URL_服务器: http://kf.lyfz.net/api/v1/user/UserOperation/updateUserName
    ...
    public function updateUserName(){
        ...
        return \think\Loader::model('UserOperationLogic','logic\v1\user')->updateUserName($data);
    }
	 ...
	 * 传入JSON格式: {"sex":1}
	 * 返回JSON格式: {"meta":{"code":200,"message":"success"},"body":null}
	 * API_URL_本地: http://localhost:91/api/v1/user/UserOperation/updateSex
	 * API_URL_服务器: http://kf.lyfz.net/api/v1/user/UserOperation/updateSex
    ...
    public function updateSex(){
        ...
        return \think\Loader::model('UserOperationLogic','logic\v1\user')->updateSex($data);
    }
